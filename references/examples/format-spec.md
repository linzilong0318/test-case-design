...
| 字段名 | 类型 | 必填 | 说明 |
|--------|------|------|------|
| `caseCode` | string | 是 | 用例编号，格式见 SKILL.md 3.5 节用例编号规则 |
...
| type 值 | 含义 | 适用场景 |
|---------|------|---------|
| 1 | 功能测试 | CRUD、表单验证、状态流转、业务规则、数据校验、集成场景 |
...
| 字段 | 说明 | 必填 |
|------|------|------|
| 用例编号 | 格式见 SKILL.md 3.5 节用例编号规则 | 是 |
